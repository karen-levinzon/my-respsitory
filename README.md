...
> **Note**: Before you look at the following images of code, I just want to say that I was not able to access the actual code for this project, so the following images include very similar code from when I was testing out how I wanted to design my webpage before I switched to actually beginning to code it. So the following code will not be the exact code for this webpage, but very similar! :)

The CSS area of the code. Here is where the main design of the webpage is coded, including the text sizes and colors, the page background, and so on.
<br>
<img src="https://github.com/user-attachments/assets/571c8466-41fa-4851-ab2c-f4afaa24f576" width = "500"/>
